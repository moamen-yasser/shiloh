...
return (
    <>
        ...
        <Container>
            <Row>
                <Col md="7" sm="12" className="bannartext wow slideInLeft" data-wow-duration="1s" data-wow-delay="0.1s"> 
                <p>WEB DESIGN <span>//</span> WEBFLOW DEVELOPMENT <span>//</span> SEO</p>
                <h1>Turn your website into a customer-acquisition engine.</h1>
                <h5>We build marketing websites that help you sell on autopilot.</h5>
                <HashLink to="/#contact"><button>Let's talk</button></HashLink>
                </Col>
                <Col md="5" sm="12" className="bannarimgs wow slideInRight" data-wow-duration="1s" data-wow-delay="0.1s">
        ...
        <section className='homesec2'>
            <Container>
                <Row>
                    <Col md='6' sm='12' className="images2 wow slideInLeft" data-wow-duration="1.5s" data-wow-delay="0.3s">
                    ...
                    <Col md='6' sm='12' className="sec2text wow slideInRight" data-wow-duration="1.5s" data-wow-delay="0.1s">
